...
type RRequest struct {
	...
	Rtype int64 `protobuf:"varint,1,opt,name=rtype,proto3" json:"rtype,omitempty"`
}
...
func (x *RRequest) GetRtype() int64 {
	if x != nil {
		return x.Rtype
	}
	return 0
...
func (x *RReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RReply) ProtoMessage() {}

func (x *RReply) ProtoReflect() protoreflect.Message {
	mi := &file_greeter_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RReply.ProtoReflect.Descriptor instead.
func (*RReply) Descriptor() ([]byte, []int) {
	return file_greeter_proto_rawDescGZIP(), []int{3}
}

func (x *RReply) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_greeter_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x20, 0x0a, 0x08, 0x52, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x72, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x05, 0x72, 0x74, 0x79, 0x70, 0x65, 0x22, 0x22, 0x0a, 0x06, 0x52, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xcb,
	0x01, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x5e, 0x0a, 0x08, 0x53, 0x61,
	...
	0x72, 0x6c, 0x64, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x12, 0x60, 0x0a, 0x15, 0x69, 0x6e,
	0x73, 0x65, 0x72, 0x74, 0x52, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x52, 0x65, 0x64, 0x69, 0x73, 0x44,
	0x61, 0x74, 0x61, 0x12, 0x17, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64,
	0x2e, 0x76, 0x31, 0x2e, 0x52, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x68,
	0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x52, 0x65,
	0x70, 0x6c, 0x79, 0x22, 0x17, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x11, 0x12, 0x0f, 0x2f, 0x69, 0x6e,
	0x73, 0x65, 0x72, 0x74, 0x2f, 0x7b, 0x72, 0x74, 0x79, 0x70, 0x65, 0x7d, 0x42, 0x54, 0x0a, 0x1c,
	...
	0x01, 0x5a, 0x1f, 0x72, 0x65, 0x64, 0x69, 0x73, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x61, 0x70,
...
var file_greeter_proto_goTypes = []interface{}{
	...
	(*RRequest)(nil),     // 2: helloworld.v1.RRequest
	(*RReply)(nil),       // 3: helloworld.v1.RReply
}
var file_greeter_proto_depIdxs = []int32{
	0, // 0: helloworld.v1.Greeter.SayHello:input_type -> helloworld.v1.HelloRequest
	2, // 1: helloworld.v1.Greeter.insertRandomRedisData:input_type -> helloworld.v1.RRequest
	1, // 2: helloworld.v1.Greeter.SayHello:output_type -> helloworld.v1.HelloReply
	3, // 3: helloworld.v1.Greeter.insertRandomRedisData:output_type -> helloworld.v1.RReply
